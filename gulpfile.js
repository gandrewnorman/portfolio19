...
gulp.task('replaceHtmlBlock', function() {
    return gulp
        ...
        .pipe(gulp.dest('dist/')).on('end', function(){ log('Replaced Html Block'); });
});
...
// Build task
gulp.task('build',gulp.series(gulp.parallel('css:minify', 'js:minify', 'vendor:minify','vendor:build', 'vendor', 'replaceHtmlBlock'),
        // function copyAssets() {
        //     return gulp
